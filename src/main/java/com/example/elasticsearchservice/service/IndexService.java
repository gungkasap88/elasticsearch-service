...
import com.example.elasticsearchservice.helper.Util;
...
public class IndexService {
    ...
    private static final List<String> INDICES = List.of(Indices.PERSON_INDEX);
    ...
    private void recreateIndices(final boolean deleteExisting) {
